...
import Intro from '../../../(directory)/provider/Components/Intro';
import RepeatHouseDiv from '../../../(directory)/provider/Components/RepeatHouseDiv';
import DirectorySidebar from '../../../(directory)/provider/Components/DirectorySidebar';
